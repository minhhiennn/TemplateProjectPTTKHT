			...
			<nav class="classy-navbar justify-content-between" id="cleverNav">
				...
				<div class="classy-menu">
					...
					<div class="classynav">
						...
						<c:otherwise>
						<li><a href="home">${currentUser.iD_User}</a></li>
						</c:otherwise>
						</c:choose>
							...
							<div id="formContent">
								...
								<div class="form-container sign-in-container" id="SignIn">
									<form action="${pageContext.request.contextPath}/UserServlet">
										<input type="text" id="ID_User" class="fadeIn second"
											name="ID_User" placeholder="login"> 
											<input type="password"
											id="password" class="fadeIn third" name="password"
											placeholder="password"> 
											<button type="submit" class="shopBtn btn-block"
													value="Login" name="action">Login</button>
									</form>
								</div>
