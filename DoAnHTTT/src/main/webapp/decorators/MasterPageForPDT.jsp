...
<title></title>
<link
	href="<c:url value='/template/pdt/vendor/fontawesome-free/css/all.min.css'/>"
...
<body id="page-top">
	...
	<!-- Page Wrapper -->
	<div id="wrapper">
		<%@ include file="/common/pdt/sidebar.jsp"%>
		<div id="content-wrapper" class="d-flex flex-column">
			<!-- Main Content -->
			<div id="content">
				<%@ include file="/common/pdt/header.jsp"%>
				<dec:body />
			</div>
			<%@ include file="/common/pdt/footer.jsp"%>
		</div>
	</div>
	...
	<script
		src="<c:url value='/template/pdt/vendor/jquery-easing/jquery.easing.min.js'/>"></script>

	<!-- Custom scripts for all pages-->
	<script src="<c:url value='/template/pdt/js/sb-admin-2.min.js'/>"></script>

	<!-- Page level plugins -->
	<script
		src="<c:url value='/template/pdt/vendor/chart.js/Chart.min.js'/>"></script>
