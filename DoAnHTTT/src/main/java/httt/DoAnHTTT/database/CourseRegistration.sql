...
select * from Faculty;
--
insert into Class Values(N'DH18DT','DT',100,7)
...
--DELETE FROM Student WHERE ID_Student like '181%' and ID_Student != '18130005' ;
--DELETE FROM USERS WHERE ID_User like '181%' and ID_User != '18130005';
--DELETE FROM Class WHERE Class_code like 'DH18%';